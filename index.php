  ...
  <section id="container">
    ...
    <footer class="site-footer" style="margin-top: 40vh;">
      <div class="text-center">
        <p>
          &copy; Copyrights <strong>Kelompok 7</strong>. All Rights Reserved
        </p>
        <div class="credits">
          <!--
          ...
          -->
          Created with Dashio template by <a href="https://templatemag.com/">Kelompok 7</a>
        </div>
